...
import { PRODUCT_CATEGORIES } from "@/features/catalog/data/categoriesData";
...
const AddProduct = () => {
    ...
    return (
        <PageShell
            title={"Add Product"}
            description={" Add basic information for your new product."}
        >
                ...
                <div className='grid grid-cols-1 gap-8 sm:grid-cols-2'>
                    <div>
                        ...
                        <select
                            {...register("category")}
                            defaultValue=''
                            className='mt-3 w-full rounded-md border border-gray-300 px-3 py-3 text-sm text-gray-900 focus:border-black focus:outline-none'
                        >
